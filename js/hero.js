...
function addItem(res) {
  if (res) {
    ...
    for (var i = 0; i < work.length; i++) {
      ...
      element.innerHTML =
        work[i].capitalize() + "-&nbsp&nbsp" + res.work[work[i]];
    }
    document.getElementById("power-text").innerHTML =
      "<span style='font-size:40px;'>" + res.powerstats.strength + "<span>";
  } else return;
}
...
function init() {
  ...
  xhrRequest.open(
    "get",
    "https://www.superheroapi.com/api.php/3078862828893622/" + id
  );
